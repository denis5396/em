...
export default class KucnoKino extends Component {
  state = {
    init: true,
  };
        ...
        <section id={styles.port2}>
          ...
          <div id={styles.port1b} ref={this.parentCon}>
            <div class={styles.port1bimg}>
              <img
                id="0"
                src={require('../../assets/img/kino1.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
            ...
            <div class={styles.port1bimg}>
              <img
                id="1"
                src={require('../../assets//img/kino2.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="2"
                src={require('../../assets/img/kino3.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="3"
                src={require('../../assets//img/kino4.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="4"
                src={require('../../assets//img/kino5.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="5"
                src={require('../../assets//img/kino6.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="6"
                src={require('../../assets//img/kino7.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="7"
                src={require('../../assets//img/kino8.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="8"
                src={require('../../assets//img/kino9.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets//img/kino10.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="10"
                src={require('../../assets//img/kino11.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="11"
                src={require('../../assets//img/kino12.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="12"
                src={require('../../assets//img/kino13.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="13"
                src={require('../../assets//img/kino16.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 15 && node && this.state.init) {
                    this.imgArray1.push(node);
