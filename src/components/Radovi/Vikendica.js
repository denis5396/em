...
export default class Vikendica extends Component {
  state = {
    init: true,
  };
        ...
        <section id={styles.port2}>
          ...
          <div id={styles.port1b} ref={this.parentCon}>
            <div class={styles.port1bimg}>
              <img
                id="0"
                src={require('../../assets/img/villa31.jpg')}
                alt=""
                ref={(node) => {
            ...
            <div class={styles.port1bimg}>
              <img
                id="1"
                src={require('../../assets/img/vik1.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="2"
                src={require('../../assets/img/vik2.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="3"
                src={require('../../assets/img/vik3.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="4"
                src={require('../../assets/img/vik4.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="5"
                src={require('../../assets/img/vik5.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="6"
                src={require('../../assets/img/vik6.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="7"
                src={require('../../assets/img/vik7.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="8"
                src={require('../../assets/img/vik8.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/vik10.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/vik9.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/vik11.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
