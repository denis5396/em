        ...
        <section id={styles.port2}>
          ...
          <div id={styles.port1b} ref={this.parentCon}>
            <div class={styles.port1bimg}>
              <img
                id="0"
                src={require('../../assets/img/restoran.png')}
                alt=""
                ref={(node) => {
            ...
            <div class={styles.port1bimg}>
              <img
                id="1"
                src={require('../../assets/img/restoran1.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="2"
                src={require('../../assets/img/restoran2.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="3"
                src={require('../../assets/img/restoran3.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="4"
                src={require('../../assets/img/restoran4.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="5"
                src={require('../../assets/img/restoran5.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="6"
                src={require('../../assets/img/restoran6.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="7"
                src={require('../../assets/img/restoran7.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="8"
                src={require('../../assets/img/restoran8.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/restoran9.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/restoran10.jpeg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/restoran11.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
