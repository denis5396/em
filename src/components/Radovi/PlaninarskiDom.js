...
export default class PlaninarskiDom extends Component {
  state = {
    init: true,
  };
        ...
        <section id={styles.port2}>
          ...
          <div id={styles.port1b} ref={this.parentCon}>
            ...
            <div class={styles.port1bimg}>
              <img
                id="1"
                src={require('../../assets/img/planina1.png')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="2"
                src={require('../../assets/img/planina2.png')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="3"
                src={require('../../assets/img/planina3.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="4"
                src={require('../../assets/img/planina4.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="5"
                src={require('../../assets/img/planina5.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="6"
                src={require('../../assets/img/planina6.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="7"
                src={require('../../assets/img/planina7.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="8"
                src={require('../../assets/img/planina8.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/planina9.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/planina11.webp')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/planina10.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
