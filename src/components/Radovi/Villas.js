  ...
  render() {
    ...
    return (
      <>
        ...
        <section id={styles.port1}>
          <h1>Villa South</h1>
          <div id={styles.port1b} ref={this.parentCon}>
            <div class={`${styles.port1bimg} ${styles.sd}`}>
              <img
                id="0"
                src={require('../../assets/img/vila12.jpg')}
                alt=""
                ref={(node) => {
            ...
            <div class={styles.port1bimg}>
              <img
                id="1"
                src={require('../../assets/img/southv1.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="3"
                src={require('../../assets/img/southv2.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="4"
                src={require('../../assets/img/southv3.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="5"
                src={require('../../assets/img/southv4.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="6"
                src={require('../../assets/img/southv5.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="7"
                src={require('../../assets/img/southv6.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="8"
                src={require('../../assets/img/southv7.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="9"
                src={require('../../assets/img/southv8.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="10"
                src={require('../../assets/img/southv9.webp')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
            ...
            <div class={styles.port1bimg}>
              <img
                id="11"
                src={require('../../assets/img/southv20.jpg')}
                alt=""
                ref={(node) => {
                  if (this.imgArray1.length < 13 && node && this.state.init) {
                    this.imgArray1.push(node);
